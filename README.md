...
•	Insight: No strong correlation was found because the dots were scattered (No pattern formed, and the R2 value was not up to 0.99). Also, higher ratings = lower discounts due to the downward slope trendline.
